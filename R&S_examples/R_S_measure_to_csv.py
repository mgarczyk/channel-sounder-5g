...
instrument = RsInstrument('TCPIP::192.168.0.20::5025::SOCKET', True, True, "SelectVisa='socket'")
'''
- option SelectVisa:
...
def meas_prep():
    ...
    instrument.write_str_with_opc('FREQuency:CENTer 20e9')  # Center Frequency to 2450 MHz
    instrument.write_str_with_opc('FREQuency:SPAN 1e6')  # SPAN is 100 MHz now
